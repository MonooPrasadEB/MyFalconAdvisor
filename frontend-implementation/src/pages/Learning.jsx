  ...
  const markLessonComplete = (topicId, lessonId) => {
    ...
    if (!completedLessons.includes(lessonKey)) {
      ...
      if (user?.id) {
        ...
        if (gamificationData.totalPoints) {
          gamificationData.totalPoints += 50 // 50 points per lesson
          
          // Update weekly learning goal
          if (gamificationData.weeklyGoals?.learning) {
            gamificationData.weeklyGoals.learning.current += 1
            if (gamificationData.weeklyGoals.learning.current >= gamificationData.weeklyGoals.learning.target) {
              gamificationData.weeklyGoals.learning.completed = true
            }
          }
