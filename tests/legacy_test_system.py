#!/usr/bin/env python3
"""
Test script for the MyFalconAdvisor system.
...
from myfalconadvisor.tools.market_data import market_data_service
...
def run_interactive_test():
    ...
    print("Ask MyFalconAdvisor a question (or press Enter to skip):")
...
def main():
    """Main test function."""
    print("🧪 MyFalconAdvisor System Test")
    print("=" * 50)
