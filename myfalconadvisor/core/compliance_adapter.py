...
from myfalconadvisor.agents.compliance_agent import (
...
class ComplianceAdapter:
    def __init__(self, policy_path: Optional[str]="policies.json", watch: bool=True, watch_interval_sec: int=5):
    ...
    def check_trade(self, **kwargs): 
        ...
        from myfalconadvisor.agents.compliance_agent import _dataclass_to_dict
